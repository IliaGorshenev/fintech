...
//     { id: 1, name: 'Рубли', code: 'RUB', symbol: '₽', amount: '250 000', color: '#2E7D32' },
//     { id: 2, name: 'Доллары', code: 'USD', symbol: '$', amount: '2 500', color: '#1565C0' },
//     { id: 3, name: 'Евро', code: 'EUR', symbol: '€', amount: '1 250', color: '#5E35B1' },
//   ]);
...
//           <FormGroup>
//             <SelectField label="Офис приёма" options={officeOptions} value={selectedOffice} onChange={setSelectedOffice} placeholder="Адрес офиса" />
//           </FormGroup>
//           <FormGroup>
//             <SelectField label="Офис получения" options={officeOptions} value={selectedOffice} onChange={setSelectedOffice} placeholder="Адрес офиса" />
//           </FormGroup>

//           <FormGroup>
//             <SelectField label="Валюта к передаче" options={currencyOptions} value={sendingCurrency} onChange={setSendingCurrency} placeholder="Отправляемая валюта" />
//           </FormGroup>

//           <FormGroup>
//             <InputWithSymbol>
//               <InputField label="Желаемая сумма к получению" placeholder="Введите сумму" type="text" value={amount} onChange={(e) => setAmount(e.target.value)} />
//             </InputWithSymbol>
//           </FormGroup>

//           <FormGroup>
//             <InputField label="Комментарий" type="textarea" value={comment} onChange={(e) => setComment(e.target.value)} placeholder="Напишите свои пожелания" rows={5} />
//           </FormGroup>
//           <FormGroup>
//             <InputField label="Промокод" placeholder="Введите промокод" type="text" value={promoCode} onChange={(e) => setPromoCode(e.target.value)} />
//           </FormGroup>
//           <InfoBox>
//             <InfoIcon></InfoIcon>
//             <InfoText>Расчёт предварительный, курс выдаётся клиенту индивидуально в чате с менеджером</InfoText>
